...
class GenerateCert extends React.Component {
      ...
      await certification.methods
        ...
        .then((res) => {
          console.log("Success in revoking certificate:", revokeCertificateId);
           toast.success(`Successfully revoked the certificate with id: ${revokeCertificateId}`);
    ...
    try {
      await certification.methods
        ...
        .then((res) => {
          ...
          toast.success(`Successfully generated a certificate with id : ${certId}`);
          this.setState({
  ...
  render() {
    ...
    return (
      <>
        {renderLoading ? (
          <div style={{backgroundColor: "rgb(24,24,25)",color: "white"}}>
          <Loader text="Connecting..."/>
          <center><br></br>
            If not getting connected, please coonect to the right network and refresh the page
            </center>
          </div>
        ) : renderMetaMaskError ? (
          <div id="error1">
        ...
        {isLegitInstitute && (
          <>
            ...
            <Grid  container align="center" justify="center" alignItems="center" style={{backgroundColor:"rgb(24,24,25"}}>
              <Grid item xs={8} sm={8}>
                <Typography
                  variant="h4"
                  color="primary"
                ...
                <Typography
                  ...
                  style={{ marginTop: "30px",color: "white" }}
                >
                  You may create or revoke a certificate on the Ethereum Blockchain
                </Typography>
                <Paper id="institutepage" className={classes.paper} style={{backgroundColor:"#79d94d"}}>
